...
public class ScanConfigUtil {
    ...
    public ScanConfigUtil(String jsonCfgFilePath) {
        try {
            ObjectMapper mapper = new ObjectMapper();
            mapData = mapper.readValue(Paths.get(jsonCfgFilePath).toFile(), Map.class);
        } catch (Exception e) {
